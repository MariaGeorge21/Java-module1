	...
	public class Employee extends Person implements Comparable{
		...
		public void setSalary(double salary) {
		 ...
		 public String toString() { return "Employee [empId=" + empId +
		  ...
		  ", getGender()=" + getGender() + ", getAge()=" + getAge() + "]"; }
			 ...
			 * if(obj!=null) ref=(Employee)obj; if(this.empId==ref.empId &&
			 * ref.getName().equals(this.getName())&& ref.getDeptno()==this.deptno) return
			 ...
			 */
			 ...
			 Employee other=(Employee)obj; return Objects.equals(deptno, other.deptno)&&
			  empId==other.empId &&
		...
		//@Override
		/*
		 * public int hashCode() { int code = this.hashCode()
